...
class WorkNode(Node):
    def __init__(self, nodeId, neighborList, bandwidth, fixedDelay, data):
        ...
        self.paramList = {"conv_filters": copy.deepcopy(Constent.CONV_FILTERS),
                          "softmax_weights": copy.deepcopy(Constent.SOFTMAX_WEIGHTS),
                          "softmax_biases": copy.deepcopy(Constent.SOFTMAX_BIASES)}
